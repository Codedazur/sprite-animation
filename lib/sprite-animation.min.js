...
typeof a&&(a=[a]);if(void 0===a)l=[],m=[];else{var b,d;for(d in a)b=a[d],void 0!==l[b]&&(void 0!==m[l[b].meta.image]&&(m[l[b].meta.image]=void 0),l[b]=void 0)}},on:function(a,b,d){q.on(a,b,d)},one:function(a,b,d){q.one(a,b,d)},off:function(a,d,h){q.off(a,d,h)}};return p._instance};p.getInstance=function(){return p._instance||new p};return function(q,w){var s=d("<div></div>"),t=void 0!==w?w:!0,l=!1,u=void 0!==window.devicePixelRatio&&1<window.devicePixelRation||void 0===window.devicePixelRation&&1<
Math.round(window.screen.availWidth/document.documentElement.clientWidth)?!0:!1,f,m,n=!0,x=!1,z=!1,y=!1,a=[],h,r,v,k,b,M,A=p.getInstance(),F,N,O,P,Q,R,G,S,H,I,T,J,B,D,K,E,L;N=function(){for(var c in a)a[c].setup||F(c,a[c].frameName,a[c].delimiter,a[c].startIndex,a[c].fps);Q()};F=function(c,g,e,C,d){var b={frameName:g,delimiter:e,setup:!1,startIndex:C,fps:d};a[c]&&(a[c].shouldPlay&&(b.shouldPlay=!0),a[c].loop&&(b.loop=a[c].loop));if(x){for(var h=[],f,l,k,m=A.atlases();(l=O(g,e,C),f=P(l))&&-1!==f&&
1E5>C;)k=m[f].frames[l],k.name=l,k.image=m[f].meta.image,k.scale=m[f].meta.scale,h.push(k),C+=1;b.fps=d;b.from=0;b.to=h.length-1;b.frames=h;void 0===b.loop&&(b.loop=!1);a[c]=b}else a[c]=b,L()};P=function(c){var a=-1,e;for(e in A.atlases())if(A.atlases()[e].frames[c]){a=e;break}return a};O=function(c,a,e){var b=c.split(a).length-1;for(e=e.toString();e.length<b;)e="0"+e;return c.substr(0,c.indexOf(a))+e+c.substr(c.lastIndexOf(a)+1,c.length)};K=function(c,g){var e,b;e=0;for(b=a[c].frames.length;e<b;e+=
1)if(a[c].frames[e].name===g)return e;return-1};T=function(){var c={w:0,h:0},g,e,b;for(g in a)for(e in a[g].frames)b=a[g].frames[e],b.sourceSize.w>c.w&&b.sourceSize.h>c.h&&(c.w=b.sourceSize.w/b.scale,c.h=b.sourceSize.h/b.scale);return c};Q=function(){var c;z=!0;R();D("sprite-animation:ready");for(c in a)if(a[c].shouldPlay){J(c,a[c]);break}};R=function(){var a=T();f=d('<canvas width="'+a.w+'" height="'+a.h+'"></canvas>')[0];u&&d(f).css({"-moz-transform":"scale(0.5, 0.5)","-ms-transform":"scale(0.5, 0.5)",
"-webkit-transform":"scale(0.5, 0.5)",transform:"scale(0.5, 0.5)","-moz-transform-origin":"0% 0%","-ms-transform-origin":"0% 0%","-webkit-transform-origin":"0% 0%","transform-origin":"0% 0%"});q&&t&&G();m=f.getContext("2d")};G=function(){l=!0;d(q).empty();d(q).append(f);v&&H()};S=function(){l&&(d(f).remove(),m=f=null)};H=function(){d(f).css({position:"relative",top:v.y+"px",left:v.x+"px"})};I=function(){return void 0===document.createElement("canvas").getContext||navigator.userAgent.match(/(Android (1.0|1.1|1.5|1.6|2.0|2.1))|(GT-P5110)|(Windows Phone (OS 7))|(XBLWP)|(ZuneWP)|(w(eb)?OSBrowser)|(webOS)|(Kindle\/(1.0|2.0|2.5|3.0))/)?
